    ...
    $scope.getEnrollees = function () {
        ...
        res.error(function (data, status, headers, config) {
                ...
                if (unauthorized) {
                    ...
                    var htmlMessage = "<h2>Please <a href=\"http://abiturient-ivansaprykin.rhcloud.com/#/login\">log-in</a></h2>";
                    swal({
                            title: "Access denied",
                            text: "Please log-in",
                            type: "warning",
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                location.href = "http://abiturient-ivansaprykin.rhcloud.com/#/login";
...
controllers.LoginController = function ($scope, $http) {
    ...
    $scope.login = function () {
        ...
        res.success(function (data, status, headers, config) {
            location.href = "http://abiturient-ivansaprykin.rhcloud.com/#/user/enrollees";
